...
def Pluronic_3d(PV,params):
    ...
    def runSeqScript(_PV, params):  # ,thread_kill):# port = None, dir = None, vol = None, rat = None):
        ...
        for hour in range(params['hours']):
            ...
            i = 0
            while flag and i < 1:
                flag = RunAtPort_threadCheck(_PV, p=6, r=300, v=1000, d='Infuse') and \
                       RunAtPort_threadCheck(_PV, p=6, r=100, v=2000, d='Infuse')
                i += 1
            if _PV.thread_kill.is_set():
                break
        _PV.running_seq = False
        ...
        for hour in range(params['hours']):
            ...
            while flag and i < 144:
                flag = RunAtPort_threadCheck(_PV, p=3, r=200, v=125, d='Withdraw') and \
                       ...
                       RunAtPort_threadCheck(_PV, p=6, r=200, v=50, d='Infuse') and \
                       RunAtPort_threadCheck(_PV, p=6, r=12, v=50, d='Infuse') and \
                       RunAtPort_threadCheck(_PV, p=6, r=200, v=50, d='Infuse') and \
                       RunAtPort_threadCheck(_PV, p=7, r=200, v=150, d='Infuse') and \
...
def two_bact_simp(PV,params):
    ...
    def runSeqScript(_PV, params):  # ,thread_kill):# port = None, dir = None, vol = None, rat = None):
        ...
        for hour in range(params['hours']):
            ...
            i = 0
            while flag and i < 144:
                flag = RunAtPort_threadCheck(_PV, p=3, r=200, v=75, d='Withdraw') and \
                       RunAtPort_threadCheck(_PV, p=4, r=200, v=75, d='Withdraw') and \
                       RunAtPort_threadCheck(_PV, p=6, r=200, v=50, d='Infuse') and \
                       RunAtPort_threadCheck(_PV, p=6, r=25, v=50, d='Infuse') and \
                       RunAtPort_threadCheck(_PV, p=6, r=200, v=50, d='Infuse')
