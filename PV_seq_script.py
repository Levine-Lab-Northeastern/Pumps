        ...
        for hour in range(params['hours']):
            ...
            while flag and i < 1:
                flag = RunAtPort_threadCheck(_PV, p=6, r=300, v=1000, d='Infuse') and \
                       RunAtPort_threadCheck(_PV, p=6, r=100, v=3000, d='Infuse')
                i += 1
            if _PV.thread_kill.is_set():
                break
        _PV.running_seq = False
        ...
        for hour in range(16):
            ...
            while flag and i < 5:
                flag = RunAtPort_threadCheck(_PV, p=3, r=200, v=125, d='Withdraw') and \
                       ...
                       RunAtPort_threadCheck(_PV, p=6, r=9, v=100, d='Infuse') and \
                       RunAtPort_threadCheck(_PV, p=6, r=50, v=25, d='Infuse') and \
            ...
            i = 0
            while flag and i < 1:
                flag = RunAtPort_threadCheck(_PV, p=3, r=200, v=150, d='Withdraw') and \
                       RunAtPort_threadCheck(_PV, p=4, r=200, v=150, d='Withdraw') and \
                       RunAtPort_threadCheck(_PV, p=5, r=200, v=75, d='Infuse') and \
                       RunAtPort_threadCheck(_PV, p=6, r=150, v=150, d='Infuse') and \
                       RunAtPort_threadCheck(_PV, p=7, r=200, v=275, d='Infuse') and \
                       RunAtPort_threadCheck(_PV, p=1, r=200, v=200, d='Withdraw')
